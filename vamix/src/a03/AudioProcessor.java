...
public class AudioProcessor extends SwingWorker<Integer,Void>{
	...
	public AudioProcessor(String process, File file) {
		...
		processFrame.setBounds((_screenWidth-400)/2, (_screenHeight-250)/2, 400, 250);
		
		progressLabel.setBounds(100,0,300,200);
		processFrame.add(progressLabel);
		
		cancelButton.setBounds(processFrame.getWidth()-105,185,100,35);
		okButton.setBounds(cancelButton.getX()-105,185,100,35);
